// This schema maps to the `feedback_records` table owned by the Forma Hub Postgres.
...
cube(`FeedbackRecords`, {
  ...
  dimensions: {
    ...
    metadataSource: {
      ...
      type: `string`,
      description: `Channel the response came in through (e.g. link, app, email). Distinct from sourceType, which names the system the record came from (forma_survey, csv).`,
    },
