...
<Note>
  Contacts are part of the Forma [Enterprise Edition](/self-hosting/advanced/license).
</Note>
...
- **Default attributes** — `email`, `userId`, `firstName`, `lastName`. Forma creates these itself and they cannot be deleted, which is why they have no checkbox in the table.
