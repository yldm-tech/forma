...
Forma uses a two-tier permission system:
...
Teams live under **Settings → Organization → Teams**, below the member list.

![The Teams card, listing each team and its size](/images/platform/features/user-management/teams-and-roles/teams.webp)
...
A team is granted access to a workspace one workspace at a time, under **Settings → Workspace → Team Access**. The permission there decides what the team's members can do in that workspace.

![Team Access, showing each team's permission on this workspace](/images/platform/features/user-management/teams-and-roles/workspace-access.webp)
