...
Add new members to your Forma organization to collaborate on surveys and manage Workspaces together. You can invite members individually or in bulk using CSV uploads.
...
<Steps>
  <Step title="Navigate to Settings → Organization → Teams">
    Go to **Settings → Organization → Teams**, where members are managed.
...
1. Forma sends an email to the organization member with an invitation link
...
- Forma sends an email to each organization member in the CSV
...
- View pending invitations under **Settings → Organization → Teams**
