---
title: "n8n"
description: "Integrate Forma with n8n for a streamlined workflow experience."
icon: "diagram-project"
---

<Note>
  The Forma n8n node is currently only available in the n8n self-hosted
  version as a community node. To install it go to "Settings" -> "Community
  Nodes" and install @forma/n8n-nodes-forma.
</Note>

n8n allows you to build flexible workflows focused on deep data integration. And with sharable templates and a user-friendly UI, the less technical people on your team can collaborate on them too. Unlike other tools, complexity is not a limitation. So you can build whatever you want — without stressing over budget. Hook up Forma with n8n and you can send your data to 350+ other apps. Here is how to do it.
...
![Update Question ID](/images/platform/features/integrations/n8n/update-question-id.webp)
...
<Note>
  ...
  ![Duplicate Survey](/images/platform/features/integrations/n8n/duplicate-survey.webp)
</Note>

## Step 2: Setup your n8n workflow

Go to [n8n.io](https://n8n.io) and create a new workflow. Search for “Forma” to get started:

![Add Forma Trigger](/images/platform/features/integrations/n8n/add-forma-trigger.webp)

## Step 3: Connect Forma with n8n

Now, you have to connect n8n with Forma via an API Key:

![Create new credential button](/images/platform/features/integrations/n8n/create-new-credential-btn.webp)

Click on Create New Credential button to add your host and API Key

![Add host and api key](/images/platform/features/integrations/n8n/add-api-key.webp)
...
![Successful Connection](/images/platform/features/integrations/n8n/success-connection.webp)

## Step 4: Select Event

Next, you can choose the event you want to trigger the node on. You can select multiple events:

![Select Event](/images/platform/features/integrations/n8n/select-event.webp)
...
![Selected Surveys](/images/platform/features/integrations/n8n/selected-surveys.webp)
...
![Submit Test Response](/images/platform/features/integrations/n8n/submit-test-response.webp)

Next, click on Listen for event button.

![Listen for event](/images/platform/features/integrations/n8n/listen-for-event.webp)
...
![Test Response Success](/images/platform/features/integrations/n8n/test-response-success.webp)
...
![Add Discord](/images/platform/features/integrations/n8n/add-discord.webp)
...
![Fill Discord Details](/images/platform/features/integrations/n8n/fill-discord-details.webp)

Once the execution is successful, you'll receive the content in the discord channel.

![Discord Response](/images/platform/features/integrations/n8n/discord-response.webp)