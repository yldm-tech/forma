...
available in your Forma version. Changes to draft and disabled workflows are saved automatically.
...
<Steps>
  <Step title="Open Workflows">
    Select **Workflows** in the workspace navigation, then select **New workflow**. Forma creates a
...
workflow **Valid** or **Invalid**. Select it whenever you want Forma to manually verify that the current
