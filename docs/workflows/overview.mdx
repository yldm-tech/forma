...
description: "Automate response-driven tasks in Forma with triggers, filters, actions, and observable runs."
icon: "https://d3gk2c5xim1je2.cloudfront.net/lucide/v1.16.0/workflow.svg"
---

Workflows automate tasks in response to events in Forma. You define the event that starts the workflow,
narrow down which events qualify, and choose the action Forma should perform.
...
<Note>Workflows are part of the Forma [Enterprise Edition](/self-hosting/advanced/license).</Note>
...
The builder lists the options available in your Forma version. The tables below show what you can use
today.
...
Self-hosted deployments run Workflows through the shared Redis-backed Job Runner built into the Forma web
