...
**Forma Hub** is Forma' unified feedback data layer. It stores normalized feedback from multiple input channels so teams can query, analyze, and act on it in one place.
...
To learn more, visit the Hub docs at [hub.forma.ylam.ai](https://hub.forma.ylam.ai) and the [Hub API Reference](https://hub.forma.ylam.ai/api).
