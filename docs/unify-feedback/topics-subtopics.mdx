...
1. Pick a Feedback Dataset under **Analyze → Feedback Data → Topics & Subtopics**.
2. Forma scans `value_text` across the dataset and proposes a set of **Topics** (broad categories) and **Subtopics** (specific themes within a topic).
