...
<Note>
  **Self-Hosting Requirements**: This question type requires file upload storage to be configured. If you're
  self-hosting Forma, make sure to [configure file uploads](/self-hosting/configuration/file-uploads)
  before using this feature.
</Note>

<iframe
  title="Survey Embed"
  src="https://app.forma.ylam.ai/s/oo4e6vva48w0trn01ht8krwo"
  style={{
    position: "relative",
    height: "600px",
    maxHeight: "100vh",
...
![Overview of Fill Upload question type](/images/surveys/question-type/file-upload/editor.webp)
