...
<iframe
  title="Survey Embed"
  src="https://app.forma.ylam.ai/s/vqmpasmnt5qcpsa4enheips0"
  style={{
    position: "relative",
    height: "600px",
    maxHeight: "100vh",
...
![Overview of Net Promoter Score question type](/images/surveys/question-type/net-promoter-score/editor.webp)
