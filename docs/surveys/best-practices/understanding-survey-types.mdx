---
title: "Understanding Forma Survey Types"
sidebarTitle: "Survey Types 101"
description: "This guide explains the differences between Forma Link Surveys and Website & App Surveys to help you choose the right option."
...
| **Segmentation** | You control externally | Built-in via Forma |
...
![Link survey example](/images/surveys/best-practices/link-surveys-vs-in-app-surveys/link-surveys-example.webp)
...
```
https://app.forma.ylam.ai/s/<surveyId>?embed=true&userId=123
```
...
window.addEventListener("message", (event) => {
  if (event.data === "formaSurveyCompleted") {
    closeWebView();
  }
});
```
...
- You don't need Forma attribute-based targeting & survey fatigue controls


## Website & App Surveys (SDK)

Also known as **intercept surveys**. Requires SDK integration. Forma handles targeting, triggering, and survey fatigue.

![In-app survey example](/images/surveys/best-practices/link-surveys-vs-in-app-surveys/in-app-surveys.webp)
...
**[Attribute-based Targeting](/surveys/website-app-surveys/attribute-based-targeting)**
...
- You want Forma to handle who sees which survey
...
**Need help?** [Join us in GitHub Discussions](https://github.com/yldm-tech/forma/discussions)
