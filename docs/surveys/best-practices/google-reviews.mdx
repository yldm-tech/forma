...
description: "A step-by-step guide to asking for feedback and turning it into public Google reviews with Forma."
icon: "star"
---
...
To collect Google reviews with Forma you need to:
...
Opening that link takes a signed-in user straight to the review dialog for your business. Copy it — you will paste it into Forma in step 3.
...
This gives you the private signal. The review itself happens on Google, not in Forma.
...
<Note>
  On Forma Cloud, custom external URLs in the Button URL field require a paid plan. This helps us prevent phishing. Self-hosted instances have no such restriction.
</Note>
...
<Note>
  Duplicate rather than **Add ending**: a new ending starts with the Forma default button (`Create your own Survey`, pointing at forma.ylam.ai), so you would have to enter the review link again — and if you miss it, low-rating respondents lose the link your anti-gating setup depends on.
</Note>
...
<Note>
  Workflows are part of the Forma [Enterprise Edition](/self-hosting/advanced/license).
</Note>
