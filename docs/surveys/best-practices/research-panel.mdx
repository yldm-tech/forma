...
description: "Build and manage your own research panel using Forma to collect profiling data, create targeted segments, and distribute personalized survey links to panel members."
...
Forma provides all the tools you need to build and manage a research panel:
...
<Steps>
  <Step title="Create a profiling survey">
    ...
    1. Go to [app.forma.ylam.ai](https://app.forma.ylam.ai) and click **Create Survey**
    ...
    ![Contact Info question type](/images/surveys/question-type/contact-info/editor.webp)
  ...
  <Step title="Download the responses CSV">
    ...
    ![The Download menu on the Responses tab](/images/surveys/best-practices/research-panel/download.webp)
  ...
  <Step title="Download the example contact upload CSV">
    ...
    ![Download example contacts CSV](/images/surveys/best-practices/panel-management/download-example-contacts.webp)
    
    The example CSV shows you the format Forma expects for contact uploads, including required fields like email and optional attribute columns.
  </Step>
  ...
  <Step title="Upload contacts to Forma">
    Import your panel members into Forma:
    ...
    Your panel members are now stored in Forma with their profiling attributes.
  </Step>
  ...
  <Step title="Create segments for targeting">
    ...
    ![Create a new segment](/images/surveys/website-app-surveys/targeting/contacts.webp)
    ...
    ![Attribute filter](/images/surveys/website-app-surveys/targeting/attribute-filter.webp)
    
    4. Name your segment descriptively (e.g., "Tech SMB Professionals")
    5. Save the segment
    
    Create multiple segments for different research needs. Learn more about [Attribute-based Targeting](/surveys/website-app-surveys/attribute-based-targeting) for detailed segmentation options.
  ...
  <Step title="Generate personal links for your segment">
    ...
    ![Personal Links](/images/surveys/best-practices/panel-management/personal-links.webp)
    
    You'll receive a CSV file containing unique survey links for each panel member in the segment. Learn more about [Personal Links](/surveys/link-surveys/personal-links).
  </Step>
...
- [Personal Links](/surveys/link-surveys/personal-links) - Learn more about generating and managing personal survey links
- [Attribute-based Targeting](/surveys/website-app-surveys/attribute-based-targeting) - Explore detailed segmentation options
- [Hidden Fields](/surveys/general-features/hidden-fields) - Pass additional data into surveys via URL parameters
