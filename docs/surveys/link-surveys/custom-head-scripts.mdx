...
<Note>
  Custom Head Scripts is only available for **Link Surveys on self-hosted instances**. This feature is not available for Website & App Surveys or on Forma Cloud.
</Note>
...
<Frame>
  <img src="/images/surveys/link-surveys/custom-head-scripts/workspace-setting.webp" alt="Custom Scripts in Workspace Settings" />
</Frame>

<Steps>
  <Step title="Navigate to Settings → Workspace → General">
    Go to **Settings → Workspace → General** from the main navigation menu.
  </Step>

  <Step title="Locate Custom Scripts Section">
    Scroll down to the **Custom Scripts** card on the General page.
  </Step>
...
<Frame>
  <img src="/images/surveys/link-surveys/custom-head-scripts/share-survey-modal-setting.webp" alt="Custom HTML tab in Share Survey Modal" />  
</Frame>
...
- **Self-Hosted Only** — This feature is only available on self-hosted instances. Forma Cloud does not support Custom Head Scripts for security and performance reasons.
...
1. **Is it a self-hosted instance?** Custom scripts only work on self-hosted Forma.
