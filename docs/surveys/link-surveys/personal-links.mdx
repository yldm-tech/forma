...
<Steps>
  ...
  <Step title="Select Personal Links tab">
    ...
    ![The Personal links tab of the Share modal](/images/surveys/link-surveys/personal-links/generate.webp)
  </Step>
...
| Column | Description |
|--------|-------------|
| **Forma Contact ID** | Internal contact identifier (`contactId`) |
...
- **CSV storage**: Generated link lists are not retained in Forma - download and store your CSV files securely
