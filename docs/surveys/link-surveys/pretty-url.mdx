...
<Note>
  **Self-Hosted Only**: Pretty URLs are available exclusively on self-hosted Forma instances. This feature is not available on Forma Cloud.
</Note>
...
<Steps>
  ...
  <Step title="Go to the Pretty URL tab">
    ...
    ![The Pretty URL tab of the Share modal](/images/surveys/link-surveys/pretty-url/custom-slug.webp)
  </Step>
...
| Uniqueness | Must be unique across your entire Forma instance |
