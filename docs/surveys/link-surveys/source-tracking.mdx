...
https://forma.ylam.ai/s/clin3dxja02k8l80hpwmx4bjy?source=Google
```
...
3. **View Responses**: The value lands in the response's metadata, alongside the URL, browser, OS, device and country Forma records anyway. Open the **Responses** tab and scroll the table right to reach those columns.
