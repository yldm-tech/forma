...
Forma deprecated the legacy Environment ID for SDK setup and now uses **Workspace ID** as the primary identifier.
...
Forma moved from an environment-centric model to a workspace-centric model to simplify setup, reduce confusion,
...
<Steps>
  <Step title="Open Web & Mobile SDK">
    In Forma, go to **Settings → Workspace → Web & Mobile SDK** and find the **Workspace details** card.
  </Step>
...
Use the [Framework Guides](https://forma.ylam.ai/docs/surveys/website-app-surveys/framework-guides)
