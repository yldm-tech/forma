...
The Cooldown Period is a universal blocker that makes sure no user sees too many surveys in a short time. It is measured **across all surveys** in a workspace, which is especially helpful when several teams use Forma at the same time. It is one layer of the full display logic — see [Survey Display Logic](/surveys/website-app-surveys/survey-display-logic) for how it combines with targeting, Recontact Options, and triggers.
...
![The workspace-wide Cooldown Period setting](/images/surveys/website-app-surveys/cooldown-period/workspace-setting.webp)
...
Still struggling or is something not working as expected? [Join us in GitHub Discussions](https://github.com/yldm-tech/forma/discussions) and we'd be glad to assist you!
