...
<Note>
  The time of day and the time zone are properties of the Forma instance, not of the survey. The editor tells you which apply — for example "Survey will be published at 00:00 in the Europe/Berlin timezone on the selected date".
</Note>
