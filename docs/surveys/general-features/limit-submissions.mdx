...
description: "Automatically close your survey after reaching a set number of responses in Forma. This is useful for limited offers, exclusive surveys, or when you need a specific sample size."
icon: "lock"
---
...
![Limit Submissions](/images/surveys/general-features/limit-submissions/response-option.webp)
