...
Spam protection feature protects your Forma instance from spam and automated abuse by verifying that survey responses are submitted by real users. This guide explains how to enable and configure spam protection in your Forma instance using Google reCAPTCHA v3.
...
<Warning>
  **Not available on Forma EU Cloud.** Spam protection is built on Google reCAPTCHA, which we do not
...
2. Register a new site:
   - **Label:** Any name (e.g., "Forma Self-Hosted")
...
If your self-hosted Forma instance is behind a firewall or proxy, ensure it can reach the Google reCAPTCHA verification endpoint:
...
You can enable Google reCAPTCHA v3 spam protection for your survey directly from the Forma Survey Editor. This helps prevent automated and spammy responses.
...
![Set reCAPTCHA Threshold](/images/surveys/general-features/spam-protection/response-option.webp)
...
For help, join the conversation on [GitHub Discussions](https://github.com/yldm-tech/forma/discussions).
