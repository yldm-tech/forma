...
Tracking of partial submissions is automatically enabled for all Forma surveys, capturing every interaction from the moment a respondent begins the survey.
...
Forma provides detailed analytics for partial submissions, including a per-question analysis of respondent behavior.

![Partial Submissions](/images/surveys/general-features/partial-submissions/step-one.webp)
...
By leveraging the partial submissions tracking feature in Forma, you gain comprehensive insights into respondent behaviors and survey interactions. This information is vital for enhancing survey design, improving response rates, and ensuring more reliable and meaningful data collection.
