...
Quotas live in the survey editor, on the **Settings** tab:

![The Quotas section of the survey editor settings](/images/surveys/general-features/quota-management/quotas.webp)
...
When you set up quotas for your survey, Forma automatically tracks responses against your defined limits. Once a quota is reached, the system can:
