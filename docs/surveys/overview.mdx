---
title: "Surveys"
description: "Design, distribute, and analyze surveys with Forma."
icon: "tablet-screen"
---

Forma surveys let you collect feedback from customers, users, and employees through link surveys, website surveys, and in-app surveys.
...
Each survey has a built-in summary view and response table. Export to CSV/XLSX, or stream responses out via webhooks and the REST API.
