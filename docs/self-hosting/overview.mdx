---
title: "Self-Hosting"
description: "Learn how to self-host Forma."
icon: "server"
---

## System requirements

Forma is not a single container. The v6 baseline runs eight long-running services — the app,
Forma Hub (API and worker), Cube, PostgreSQL, Redis/Valkey, SpiceDB and its operator — so size the
...
Chart defaults request 1.9 vCPU and 2.9 GiB across those services — see `charts/forma/values.yaml`,
...
* [**One-Click Setup**](/self-hosting/setup/one-click)**:** Set up Forma on Ubuntu in minutes with our shell script.
...
* [**Migration Guide**](/self-hosting/advanced/migration)**:** Upgrade your existing Forma instance smoothly.

* [**Configuration**](/self-hosting/configuration)**:** Customize your setup with advanced configurations.

* [**Integrations**](/self-hosting/configuration/integrations)**:** Connect Forma to third-party tools.

* [**Licensing**](/self-hosting/advanced/license)**:**  Learn more about our AGPL Forma Core and its open-source license & Unlock advanced features tailored for larger teams and enterprises with the EE License.

## **Hosting options**

* **Cloud Hosting:** Hassle-free managed deployment at [app.forma.ylam.ai](https://app.forma.ylam.ai).
...
For licensing queries, contact us at [**hola@forma.ylam.ai**]().

Forma is designed to be intuitive and accessible, ensuring an easy setup no matter which option you choose. Start using Forma today and take your surveys to the next level!

**Need Help?**
Join the conversation on [**GitHub Discussions**](https://github.com/yldm-tech/forma/discussions).