...
<Note>
  ...
  [here](/platform/features/integrations/slack) to set it up.
</Note>
...
<Note>Make sure your self-hosted Forma instance works with SSL as Slack requires it.</Note>
...
* Go to the **Basic Information** tab on the sidebar and copy the **Client ID** and **Client Secret**. Copy them & add it to your **Forma environment variables** as in the docker compose file:
...
Voila! You have successfully enabled the Slack integration in your self-hosted Forma instance. Now you can follow the steps mentioned in the [Slack Integration](/platform/features/integrations/slack) section to link a Slack workspace with Forma.
