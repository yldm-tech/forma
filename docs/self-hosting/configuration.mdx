...
description: "Everything you can configure on a self-hosted Forma instance, and where each setting lives."
icon: "sliders"
---
...
Forma sends verification mail, invitations, email follow-ups and email surveys. None of that works until you point the instance at an SMTP server.

<CardGroup cols={2}>
  <Card title="SMTP" icon="envelope" href="/self-hosting/configuration/smtp">
    Point Forma at a mail server.
  </Card>
...
Where Forma lives on the network, and how browsers get to it.
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Subpath" icon="folder-tree" href="/self-hosting/configuration/custom-subpath">
    Serve Forma under a path prefix instead of a domain root.
  </Card>
...
<Card title="AI Features" icon="sparkles" href="/self-hosting/advanced/enterprise-features/ai-features">
  Point the instance at Qwen/vLLM, Google Cloud, Azure or Bedrock, and turn AI on for your organization.
</Card>
