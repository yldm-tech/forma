---
title: "Documentation"
description: "Standards for documenting code and features in the Forma codebase"
icon: "book"
---

## Overview

At Forma, we maintain strict documentation standards to ensure code clarity, maintainability, and ease of use for both internal developers and external contributors.

### Contribute to Documentation

We use Mintlify to maintain our documentation. You can find more information about how to contribute to the documentation in the [README](https://github.com/yldm-tech/forma/blob/main/docs/README.md) file.
...
2. **Navigation**
   - Add new pages to the appropriate section in `docs/docs.json`
