...
description: "How we test Forma to ensure reliability, performance, and high-quality code."
icon: magnifying-glass
---

## Overview

At Forma, we maintain a rigorous testing strategy to ensure high-quality code and reliable functionality. Our testing approach is standardized and integrated into our development workflow.
