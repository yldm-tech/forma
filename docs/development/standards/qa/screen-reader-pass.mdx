...
Forma embeds but does not control:
...
- **Embedded video** (YouTube, Vimeo, Loom). Forma provides no route to captions, a transcript
...
[accessibility issue template](https://github.com/yldm-tech/forma/issues/new?labels=accessibility&template=accessibility.yml);
