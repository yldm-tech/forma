...
Forma gateway auth is split into three layers:
...
The public contract of the FeedbackRecords service — the eight operations the authorizer allows, and the
two error shapes a caller sees — is documented in the
[API v3 reference](/api-v3-reference/introduction), which is unlisted and in private beta.
