...
icon: "key"
description: "Here is how you can generate an API key which gives you full access to the Forma Management API. Keep it safe!"
---
...
<Note>
  On Forma Cloud, organization user-management endpoints (creating and updating members) are not available. Organization Access is primarily intended for self-hosted instances.
</Note>
