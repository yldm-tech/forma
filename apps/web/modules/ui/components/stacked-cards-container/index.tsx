    ...
    case "casual":
      return (
        <div className="group relative mx-auto w-full" style={{ maxWidth: linkSurveyCardMaxWidth }}>
          ...
          <div className="flex scale-[0.995] flex-col items-center justify-center rounded-xl border border-slate-200 bg-white/70 p-16 backdrop-blur-lg transition-all duration-200 ease-in-out group-hover:scale-[1]">
            {children}
          </div>
        </div>
      );
