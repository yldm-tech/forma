...
import { ConfirmPasswordForm } from "@/modules/two-factor-auth/components/confirm-password-form";
import { DisplayBackupCodes } from "@/modules/two-factor-auth/components/display-backup-codes";
import { EnterCode } from "@/modules/two-factor-auth/components/enter-code";
import { ScanQRCode } from "@/modules/two-factor-auth/components/scan-qr-code";
import {
  Dialog,
  DialogBody,
  DialogContent,
