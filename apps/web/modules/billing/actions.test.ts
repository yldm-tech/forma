...
vi.mock("@/modules/billing/api/lib/create-customer-portal-session", () => ({
  createCustomerPortalSession: mocks.createCustomerPortalSession,
}));

vi.mock("@/modules/billing/api/lib/create-setup-checkout-session", () => ({
  createSetupCheckoutSession: mocks.createSetupCheckoutSession,
}));

vi.mock("@/modules/billing/api/lib/is-subscription-cancelled", () => ({
...
vi.mock("@/modules/billing/lib/stripe-client", () => ({
  stripeClient: {
    customerSessions: {
