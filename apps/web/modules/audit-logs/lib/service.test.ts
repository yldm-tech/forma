...
vi.mock("../../license-check/lib/utils", () => ({
...
describe("logAuditEvent", () => {
  ...
  beforeEach(async () => {
    vi.clearAllMocks();
    getIsAuditLogsEnabled = (await import("@/modules/license-check/lib/utils")).getIsAuditLogsEnabled;
    logger = (await import("@forma/logger")).logger;
  });
