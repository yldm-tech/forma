...
import { preloadConnection } from "@/modules/auth/saml/lib/preload-connection";
import { getIsSamlSsoEnabled } from "@/modules/license-check/lib/utils";
...
vi.mock("@/modules/auth/saml/lib/preload-connection", () => ({
