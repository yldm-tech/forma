...
vi.mock("@/modules/contacts/lib/contact-attributes", () => ({ getDistinctAttributeValues: vi.fn() }));
vi.mock("@/modules/contacts/segments/lib/helper", () => ({ checkForRecursiveSegmentFilter: vi.fn() }));
