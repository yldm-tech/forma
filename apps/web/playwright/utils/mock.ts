...
export const mockUsers = {
  ...
  onboarding: [
    {
      ...
      email: "onboarding1@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
    {
      name: "Onboarding User 2",
      email: "onboarding2@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
    {
      name: "Onboarding User 3",
      email: "onboarding3@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
  ],
  survey: [
    {
      name: "Survey User 1",
      email: "survey1@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
    {
      name: "Survey User 2",
      email: "survey2@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
    {
      name: "Survey User 3",
      email: "survey3@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
    {
      name: "Survey User 4",
      email: "survey4@forma.ylam.ai",
      password: MOCK_PASSWORD,
    },
  ],
  js: [
  ...
  action: [
    {
      name: "Action User 1",
      email: "action1@forma.ylam.ai",
    },
    {
      name: "Action User 2",
      email: "action2@forma.ylam.ai",
    },
    {
      name: "Action User 3",
      email: "action3@forma.ylam.ai",
    },
    {
      name: "Action User 4",
      email: "action4@forma.ylam.ai",
    },
    {
      name: "Action User 5",
      email: "action5@forma.ylam.ai",
    },
    {
      name: "Action User 6",
      email: "action6@forma.ylam.ai",
    },
  ],
  organization: [
    {
      name: "Organization User 1",
      email: "organization1@forma.ylam.ai",
    },
    {
      name: "Organization User 2",
      email: "organization2@forma.ylam.ai",
    },
  ],
};
