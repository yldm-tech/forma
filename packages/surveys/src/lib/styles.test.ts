...
describe("setStyleNonce and getStyleNonce", () => {
  ...
  test("should update existing forma__css element with nonce", () => {
    // Create an existing style element
    const existingElement = document.createElement("style");
    existingElement.id = "forma__css";
  ...
  test("should update existing forma__css__custom element with nonce", () => {
    // Create an existing custom style element
    const existingElement = document.createElement("style");
    existingElement.id = "forma__css__custom";
    document.head.appendChild(existingElement);
  ...
  test("should not update nonce on existing elements when nonce is undefined", () => {
    ...
    customElement.id = "forma__css__custom";
...
describe("addStylesToDom", () => {
  ...
  afterEach(() => {
    const styleElement = document.getElementById("forma__css");
    if (styleElement) {
      styleElement.remove();
    }
    setStyleNonce(undefined);
  ...
  test("should add a style element to the head with combined CSS", () => {
    addStylesToDom();
    const styleElement = document.getElementById("forma__css") as HTMLStyleElement;
  ...
  test("should not add a new style element if one already exists", () => {
    ...
    const firstStyleElement = document.getElementById("forma__css");
    const initialInnerHTML = firstStyleElement?.innerHTML;

    addStylesToDom(); // Second call
    const secondStyleElement = document.getElementById("forma__css");
    const allStyleElements = document.querySelectorAll("#forma__css");
...
describe("addCustomThemeToDom", () => {
  ...
  afterEach(() => {
    const styleElement = document.getElementById("forma__css__custom");
    if (styleElement) {
      styleElement.remove();
    }
    setStyleNonce(undefined);
  ...
  test("should add a custom theme style element to the head", () => {
    ...
    const styleElement = document.getElementById("forma__css__custom") as HTMLStyleElement;
    expect(styleElement).not.toBeNull();
    expect(styleElement.tagName).toBe("STYLE");
    expect(document.head.contains(styleElement)).toBe(true);
  });
  ...
  test("should reuse existing custom theme style element", () => {
    ...
    const firstElement = document.getElementById("forma__css__custom");

    const styling2 = getBaseWorkspaceStyling({ brandColor: { light: "#00FF00" } });
    addCustomThemeToDom({ styling: styling2 });
    const secondElement = document.getElementById("forma__css__custom");
    const allElements = document.querySelectorAll("#forma__css__custom");
