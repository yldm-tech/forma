...
export const SEED_CREDENTIALS = {
  ADMIN: { email: "admin@forma.ylam.ai", password: "Password#123" },
  MANAGER: { email: "manager@forma.ylam.ai", password: "Password#123" },
  MEMBER: { email: "member@forma.ylam.ai", password: "Password#123" },
} as const;
