 ...
 *
 * This module deliberately imports nothing. Its consumers include `@forma/surveys`, whose
 ...
 * or the widget stops recognising it — see `getSurveyDisplayName` in `@forma/surveys`.
 */
