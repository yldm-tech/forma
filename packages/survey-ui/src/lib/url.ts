 ...
 *
 * `@forma/types` constrains the scheme of these fields, but the renderer must not depend on that
 ...
 * `startsWith` check would wave through. Kept local rather than imported from `@forma/types`
